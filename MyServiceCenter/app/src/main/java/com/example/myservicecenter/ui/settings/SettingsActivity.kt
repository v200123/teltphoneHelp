...
class SettingsActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        ...
        binding.btnSave.setOnClickListener {
            ...
            AppPreferences.setWebViewHomeData(this, binding.etWebHomeData.text?.toString().orEmpty())
            AppPreferences.setWebViewHomeBalance(this, binding.etWebHomeBalance.text?.toString().orEmpty())
